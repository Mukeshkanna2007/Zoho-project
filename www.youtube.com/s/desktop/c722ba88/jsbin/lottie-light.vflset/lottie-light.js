...
*/
  ...
  function ta(a, b, c, d) {
    try {
      var l = b.call(a.g.h, c);
      if (!(l instanceof Object))
        throw new TypeError("Iterator result " + l + " is not an object");
      if (!l.done) return (a.g.o = !1), l;
      var m = l.value;
    } catch (f) {
      return (a.g.h = null), pa(a.g, f), r(a);
    }
    a.g.h = null;
    d.call(a.g, m);
    return r(a);
  ...
  function wa(a) {
    this.next = function (b) {
      oa(a.g);
      a.g.h ? (b = ta(a, a.g.h.next, b, a.g.s)) : (a.g.s(b), (b = r(a)));
      return b;
    };
    this.throw = function (b) {
      oa(a.g);
      a.g.h ? (b = ta(a, a.g.h["throw"], b, a.g.s)) : (pa(a.g, b), (b = r(a)));
      return b;
    };
  ...
  p("Promise", function (a) {
    ...
    b.prototype.m = function () {
      ...
      var e = this,
        g = !1;
      return { resolve: f(this.I), reject: f(this.o) };
    };
    ...
    b.prototype.H = function (f) {
      ...
      typeof e == "function" ? this.M(e, f) : this.s(f);
    };
    ...
    b.prototype.J = function () {
      ...
      l(function () {
        if (f.aa()) {
          var e = h.console;
          typeof e !== "undefined" && e.error(f.j);
        }
      }, 1);
    };
    ...
    b.prototype.K = function (f) {
      var e = this.m();
      f.v(e.resolve, e.reject);
    };
    b.prototype.M = function (f, e) {
      var g = this.m();
      try {
    ...
    typeof Object.assign == "function"
      ...
      : function (a, b) {
          for (var c = 1; c < arguments.length; c++) {
            var d = arguments[c];
            if (d) for (var l in d) u(d, l) && (a[l] = d[l]);
          }
          return a;
        };
  ...
  p("WeakMap", function (a) {
    ...
    b.prototype.get = function (g) {
      return d(g) && u(g, f) ? g[f][this.g] : void 0;
    };
    b.prototype.has = function (g) {
      return d(g) && u(g, f) && u(g[f], this.g);
    };
    b.prototype.delete = function (g) {
      return d(g) && u(g, f) && u(g[f], this.g) ? delete g[f][this.g] : !1;
    };
    return b;
  });
  p("Map", function (a) {
    ...
    function d(e, g) {
      ...
      if (n && u(e[0], k))
        for (e = 0; e < n.length; e++) {
          var v = n[e];
          if ((g !== g && v.key !== v.key) || g === v.key)
            return { id: k, list: n, index: e, l: v };
        }
      return { id: k, list: n, index: -1, l: void 0 };
    }
    function l(e) {
      this[0] = {};
      this[1] = b();
    ...
    l.prototype.delete = function (e) {
      ...
      return e.l && e.list
        ? (e.list.splice(e.index, 1),
          ...
          (e.l.previous.next = e.l.next),
          (e.l.next.previous = e.l.previous),
          (e.l.head = null),
          this.size--,
          !0)
        : !1;
...
*/
  ...
  var Ia = F("about:blank"),
    Ja = F("about:invalid#zClosurez");
  function Ka(a) {
  ...
  var J = {
    ...
    Ma = [J.L, J.O, J.P, J.R, J.N, J.S];
  function Na(a, b) {
    b = b === void 0 ? Ma : b;
    if (Ka(a)) return a;
    for (var c = 0; c < b.length; ++c) {
      var d = b[c];
      if (d instanceof G && d.X(a)) return F(a);
    }
  }
  function Oa(a) {
    var b = window;
    if (
      ...
      return F(URL.createObjectURL(a));
    b = a.type;
  ...
  function K(a) {
    return a instanceof E ? La(a) : Ta(a);
  }
  var L = [];
  function Ua() {}
  function Va(a, b) {
  ...
  var ib = x(function () {
    return new S(y, z ? z.emptyScript : "");
  });
  function jb(a) {
  ...
  function wb(a, b, c) {
    return a.parseFromString(O(b), c);
  }
  function xb(a, b, c) {
    b = Error.call(
      this,
      a +
        " was requested as a " +
        b +
        ', but the response Content-Type, "' +
        c +
        " is not appropriate for this type of content."
    );
    this.message = b.message;
    "stack" in b && (this.stack = b.stack);
    this.url = a;
  ...
  la(xb, Error);
  function yb(a, b) {
    return a.createContextualFragment(O(b));
  }
  function zb(a) {
    return V(a.map(ub).join(""));
  }
  function W(a, b) {
    if (bb(a)) return a;
    a = X(String(a));
    if (b == null ? 0 : b.xa) a = a.replace(/(^|[\r\n\t ]) /g, "$1&#160;");
    if (b == null ? 0 : b.wa) a = a.replace(/(\r\n|\n|\r)/g, "<br>");
    if (b == null ? 0 : b.ya)
  ...
  function Hb(a) {
    for (var b = "", c = Object.keys(a), d = 0; d < c.length; d++) {
      ...
      if (m !== void 0 && m !== null) {
        ...
        Fb.indexOf(l.toLowerCase()) !== -1 &&
          (m = Ka(m)
            ? m.toString()
            : Ta(String(m)) || "about:invalid#zClosurez");
        m = l + '="' + W(String(m)) + '"';
        b += " " + m;
      }
    }
  ...
  Ib.prototype.format = function (a) {
    var b = this,
      c = W("_safevalues_format_marker_:").toString();
    a = W(a)
      .toString()
  ...
  var Pb =
    ...
    Nb = [
      ...
      ["VIDEO", new Map([["src", { i: 5 }]])],
      ["AUDIO", new Map([["src", { i: 5 }]])],
    ],
    Qb =
    ...
    Tb = new Mb(
      new Set(Pb.concat(["BUTTON", "INPUT"])),
      new Set(
        x(function () {
    ...
    b = document.createTreeWalker(b, 5, function (e) {
      if (e.nodeType === 3) e = 1;
        ...
        if (((e = Kb(e)), e === null)) e = 2;
          ...
          var g = a.g;
          e = e !== "FORM" && (g.j.has(e) || g.g.has(e)) ? 1 : 2;
        }
      else e = 2;
      return e;
    });
    for (
      var d = b.nextNode(), l = c.createDocumentFragment(), m = l;
      d !== null;

    ) {
      var f = void 0;
      if (d.nodeType === 3) f = document.createTextNode(d.data);
      else if (Lb(d)) f = Xb(a, d, c);
      else throw Error("");
      m.appendChild(f);
      ...
      a: {
        if ((g = e.conditions)) {
          ...
          for (var k = g.next(); !k.done; k = g.next()) {
            ...
            var v = void 0;
            if (
              (k = (v = b.getNamedItem(k)) == null ? void 0 : v.value) &&
              !n.has(k)
            ) {
              g = !1;
              break a;
        ...
        switch (e.i) {
          ...
          case 2:
            ...
            Z(
              c,
              m,
              e !== void 0 && Ra.indexOf(e.toLowerCase()) !== -1
                ? f
  ...
  function dc(a) {
    var b = a.split(/[?#]/),
      c = /[?]/.test(a) ? "?" + b[1] : "";
    return { A: b[0], D: c, B: /[#]/.test(a) ? "#" + (c ? b[2] : b[1]) : "" };
  }
  function ec(a, b, c, d) {
    function l(f, e) {
      f != null &&
  ...
  var fc = /[^#]*/;
  function gc(a) {
    return T(JSON.stringify(a).replace(/</g, "\\u003C"));
  }
  var hc = { 0: 1, 1: 1 },
    ic = { 0: 0.1, 1: 0.1 };
  function jc(a, b) {
    ...
    if (!(c = !b)) {
      ...
      c = !(
        Math.random() <
        ((l = (d = b.za) != null ? d : hc[b.F[0]]) != null ? l : 0)
      );
    }
    if (
      c ||
    ...
    var m, f;
    Math.random() <
      ((f = (m = b.va) != null ? m : ic[b.F[0]]) != null ? f : 0) &&
      kc(b, "HEARTBEAT");
    lc(a, b) || (W(a).toString() !== a && kc(b, "H_ESCAPE"));
    return a;
  }
  function lc(a, b) {
    try {
      ...
      return kc(b, "H_SLSANITIZE"), !0;
    }
    try {
      Y($b, a);
    } catch (c) {
      return kc(b, "H_RSANITIZE"), !0;
    }
    try {
      Zb(a);
    } catch (c) {
      return kc(b, "H_SANITIZE"), !0;
    }
    return !1;
  }
  function kc(a, b) {
    (mc
      ...
      : nc)(
      "https://csp.withgoogle.com/csp/lcreport/" + a.F,
      JSON.stringify({
  ...
  w("safevalues_raw.safeAttrPrefix", function (a) {
    return new mb(y, a[0].toLowerCase());
  });
  w("safevalues_raw.htmlFragment", function (a) {
    return document.createRange().createContextualFragment(O(N(a[0])));
  });
  w("safevalues_raw.svgFragment", function (a) {
    var b = document.createElementNS("http://www.w3.org/2000/svg", "svg"),
      c = document.createRange();
    c.selectNodeContents(b);
    return c.createContextualFragment(O(N(a[0])));
  });
  w("safevalues_raw.concatHtmls", Ab);
  w("safevalues_raw.doctypeHtml", function () {
    return N("<!DOCTYPE html>");
  });
  w("safevalues_raw.htmlEscape", W);
  w("safevalues_raw.joinHtmls", Bb);
  w("safevalues_raw.scriptToHtml", function (a, b) {
    a = U(a).toString();
    var c = "<script";
    if (b == null ? 0 : b.id) c += ' id="' + X(b.id) + '"';
    if (b == null ? 0 : b.nonce) c += ' nonce="' + X(b.nonce) + '"';
    if (b == null ? 0 : b.type) c += ' type="' + X(b.type) + '"';
    if (b == null ? 0 : b.defer) c += " defer";
    return N(c + (">" + a + "\x3c/script>"));
  });
  w("safevalues_raw.scriptUrlToHtml", function (a, b) {
    ...
    (b == null ? void 0 : b.attributionSrc) !== void 0 &&
      (a += ' attributionsrc="' + X(b.attributionSrc) + '"');
    if (b == null ? 0 : b.U) a += ' custom-element="' + X(b.U) + '"';
    if (b == null ? 0 : b.defer) a += " defer";
    if (b == null ? 0 : b.id) a += ' id="' + X(b.id) + '"';
    if (b == null ? 0 : b.nonce) a += ' nonce="' + X(b.nonce) + '"';
    if (b == null ? 0 : b.type) a += ' type="' + X(b.type) + '"';
    if (b == null ? 0 : b.T) a += ' crossorigin="' + X(b.T) + '"';
    return N(a + ">\x3c/script>");
  });
  w("safevalues_raw.sanitizeHtml", function (a) {
    return Y(Yb, a);
  });
  w("safevalues_raw.sanitizeHtmlAssertUnchanged", Zb);
  w("safevalues_raw.sanitizeHtmlToFragment", function (a) {
    var b = document.implementation.createHTMLDocument("");
    return Wb(Yb, a, b);
  });
  w("safevalues_raw.HtmlSanitizerBuilder", cc);
  w("safevalues_raw.appendParams", function (a, b) {
    a = dc(C(a).toString());
    return ec(a.A, a.D, a.B, b);
  });
  w("safevalues_raw.replaceParams", function (a, b) {
    a = dc(C(a).toString());
    return ec(a.A, "", a.B, b);
  });
  w("safevalues_raw.appendPathSegment", function (a, b) {
    a = dc(C(a).toString());
    b = a.A + (a.A.slice(-1) === "/" ? "" : "/") + encodeURIComponent(b);
    return B(b + a.D + a.B);
  });
  w("safevalues_raw.objectUrlFromScript", function (a) {
    a = U(a).toString();
    return B(URL.createObjectURL(new Blob([a], { type: "text/javascript" })));
  });
  w("safevalues_raw.replaceFragment", function (a, b) {
    a = C(a).toString();
    return B(fc.exec(a)[0] + (b.trim() ? "#" + b : ""));
  });
  w("safevalues_raw.toAbsoluteResourceUrl", function (a) {
    a = C(a).toString();
    a = new URL(a, window.document.baseURI);
    return B(a.toString());
  });
  w("safevalues_raw.trustedResourceUrl", function (a) {
    var b = t.apply(1, arguments);
    if (b.length === 0) return B(a[0]);
    for (var c = a[0], d = 0; d < b.length; d++)
      c += encodeURIComponent(b[d]) + a[d + 1];
    return B(c);
  });
  w("safevalues_raw.concatScripts", function (a) {
    return T(a.map(U).join(""));
  });
  w("safevalues_raw.safeScript", function (a) {
    return T(a.join(""));
  });
  w("safevalues_raw.safeScriptWithArgs", function (a) {
    return function () {
      var b = t.apply(0, arguments).map(function (c) {
        return gc(c).toString();
      });
      return T("(" + a.join("") + ")(" + b.join(",") + ")");
    };
  });
  w("safevalues_raw.valueAsScript", gc);
  w("safevalues_raw.concatStyleSheets", zb);
  w("safevalues_raw.safeStyleSheet", function (a) {
    return V(a[0]);
  });
  w("safevalues_raw.addJavaScriptUrlSanitizationCallback", function (a) {
  ...
  w("safevalues_raw.objectUrlFromSafeSource", Oa);
  w("safevalues_raw.removeJavaScriptUrlSanitizationCallback", function (a) {
    a = L.indexOf(a);
    a !== -1 && L.splice(a, 1);
  });
  w("safevalues_raw.safeUrl", function (a) {
    for (var b = t.apply(1, arguments), c = [a[0]], d = 0; d < b.length; d++)
      c.push(String(b[d])), c.push(a[d + 1]);
    return F(c.join(""));
  });
  w("safevalues_raw.SanitizableUrlScheme", J);
  w("safevalues_raw.sanitizeUrl", function (a, b) {
    b = b === void 0 ? Ma : b;
    b = Na(a, b);
    b === void 0 && Ua(a.toString());
    return b || Ja;
  });
  w("safevalues_raw.trySanitizeUrl", Na);
  w("safevalues_raw.SafeAttributePrefix", mb);
  w("safevalues_raw.unwrapAttributePrefix", nb);
  w("safevalues_raw.EMPTY_HTML", ab);
  w("safevalues_raw.isHtml", bb);
  w("safevalues_raw.SafeHtml", M);
  w("safevalues_raw.unwrapHtml", O);
  w("safevalues_raw.isResourceUrl", Ha);
  w("safevalues_raw.TrustedResourceUrl", A);
  w("safevalues_raw.unwrapResourceUrl", C);
  w("safevalues_raw.EMPTY_SCRIPT", ib);
  w("safevalues_raw.isScript", jb);
  w("safevalues_raw.SafeScript", S);
  w("safevalues_raw.unwrapScript", U);
  w("safevalues_raw.isStyleSheet", tb);
  w("safevalues_raw.SafeStyleSheet", sb);
  w("safevalues_raw.unwrapStyleSheet", ub);
  w("safevalues_raw.ABOUT_BLANK", Ia);
  w("safevalues_raw.INNOCUOUS_URL", Ja);
  w("safevalues_raw.isUrl", Ka);
  w("safevalues_raw.SafeUrl", E);
  w("safevalues_raw.unwrapUrl", La);
  w("safevalues_raw.reportOnlyHtmlPassthrough", jc);
  w("safevalues_raw.HtmlFormatter", Ib);
  w("safevalues_raw.createHtml", function (a, b, c) {
    Gb(a);
    var d = "<" + a;
    b && (d += Hb(b));
    Array.isArray(c) || (c = c === void 0 ? [] : [c]);
    Eb.indexOf(a.toUpperCase()) !== -1
      ? (d += ">")
      : ((b = Ab(
          c.map(function (l) {
            return bb(l) ? l : W(String(l));
          })
        )),
        (d += ">" + b.toString() + "</" + a + ">"));
    return N(d);
  });
  w("safevalues_raw.styleSheetToHtml", function (a, b) {
    var c = {};
    if (b)
    ...
    a = ub(a);
    return N("<style " + b + ">" + a + "</style>");
  });
  w("safevalues_raw.safeStyleRule", function (a) {
    for (var b = t.apply(1, arguments), c = a[0], d = 0; d < a.length - 1; d++)
      (c += String(b[d])), (c += a[d + 1]);
    ...
    if (
      b.cssRules.length === 1 &&
      ((c = b.cssRules[0]), c instanceof CSSStyleRule)
    )
      return V(c.cssText.replace(/</g, "\\3C "));
  });
  w("safevalues_raw.dom.setAnchorHref", Va);
  w("safevalues_raw.dom.setAnchorHref", Va);
  w("safevalues_raw.dom.setAreaHref", Wa);
  w("safevalues_raw.dom.setBaseHref", Xa);
  w("safevalues_raw.dom.setButtonFormaction", Ya);
  w("safevalues_raw.dom.buildPrefixedAttributeSetter", function (a) {
    var b = [a].concat(ma(t.apply(1, arguments)));
    return function (c, d, l) {
      ob(b, c, d, l);
    };
  });
  w("safevalues_raw.dom.elementInsertAdjacentHtml", function (a, b, c) {
    var d = b === "beforebegin" || b === "afterend" ? a.parentElement : a;
    d !== null && pb(d);
    a.insertAdjacentHTML(b, O(c));
  });
      ...
      default:
        if (/^on./.test(b))
          throw Error(
            'Attribute "' +
              b +
              '" looks like an event handler attribute. Please use a safe alternative like addEventListener instead.'
          );
        a.setAttribute(b, c);
    }
  });
  w("safevalues_raw.dom.setElementInnerHtml", function (a, b) {
    a.nodeType === 1 && pb(a);
    a.innerHTML = O(b);
  });
  w("safevalues_raw.dom.setElementOuterHtml", function (a, b) {
    var c = a.parentElement;
    c !== null && pb(c);
    a.outerHTML = O(b);
  });
  w("safevalues_raw.dom.setElementPrefixedAttribute", ob);
  w("safevalues_raw.dom.setEmbedSrc", Za);
  w("safevalues_raw.dom.setFormAction", $a);
  w("safevalues_raw.dom.IframeIntent", db);
  w("safevalues_raw.dom.TypeCannotBeUsedWithIframeIntentError", R);
  w("safevalues_raw.dom.setIframeSrc", cb);
  w("safevalues_raw.dom.setIframeSrcWithIntent", function (a, b, c) {
    a.removeAttribute("srcdoc");
    switch (b) {
      case 0:
        if (c instanceof A) throw new R("TrustedResourceUrl", 0);
        Q(a, []);
        b = K(c);
        b !== void 0 && (a.src = b);
        break;
      case 1:
        if (!(c instanceof A)) throw new R(typeof c, 1);
        Q(
          a,
        ...
        break;
      case 2:
        if (c instanceof A) throw new R("TrustedResourceUrl", 2);
        Q(
          a,
          "allow-same-origin allow-scripts allow-forms allow-popups allow-popups-to-escape-sandbox allow-storage-access-by-user-activation".split(
            " "
  ...
  w("safevalues_raw.dom.setIframeSrcdocWithIntent", function (a, b, c) {
    ...
    switch (b) {
      case 0:
        if (c instanceof M) throw new R("SafeHtml", 0);
        a.ua = "default-src 'none'";
        Q(a, []);
        P(a, N(c));
        break;
      case 1:
        if (!(c instanceof M)) throw new R("string", 1);
        Q(
          a,
          "allow-same-origin allow-scripts allow-forms allow-popups allow-popups-to-escape-sandbox allow-storage-access-by-user-activation".split(
            " "
        ...
        break;
      case 2:
        if (c instanceof M) throw new R("SafeHtml", 1);
        Q(a, [
          "allow-scripts",
          "allow-forms",
          "allow-popups",
  ...
  w("safevalues_raw.dom.setInputFormaction", eb);
  w("safevalues_raw.dom.setLinkHrefAndRel", function (a, b, c) {
    if (Ha(b)) rb(a, b, c);
    else {
      if (qb.indexOf(c) === -1)
        throw Error(
  ...
  w("safevalues_raw.dom.setLinkWithResourceUrlHrefAndRel", rb);
  w("safevalues_raw.dom.setObjectData", fb);
  w("safevalues_raw.dom.setScriptSrc", lb);
  w("safevalues_raw.dom.setScriptTextContent", function (a, b, c) {
    a.textContent = U(b);
    (c == null ? 0 : c.Y) || kb(a);
  });
  w("safevalues_raw.dom.setStyleTextContent", function (a, b) {
    a.textContent = ub(b);
  });
  w("safevalues_raw.dom.setSvgAttribute", function (a, b, c) {
    var d = b.toLowerCase();
    if (vb.indexOf(d) !== -1 || d.indexOf("on") === 0) throw Error("");
    a.setAttribute(b, c);
  });
  w("safevalues_raw.dom.setSvgUseHref", function (a, b) {
    var c = Qa(b);
    c !== "javascript:" && c !== "data:" && a.setAttribute("href", b);
  });
  w("safevalues_raw.dom.documentExecCommand", function (a, b, c) {
    b = String(b);
    var d = c;
    b.toLowerCase() === "inserthtml" && (d = O(c));
    return a.execCommand(b, !1, d);
  });
  w("safevalues_raw.dom.documentExecCommandInsertHtml", function (a, b) {
    return a.execCommand("insertHTML", !1, O(b));
  });
  w("safevalues_raw.dom.documentWrite", function (a, b) {
    a.write(O(b));
  });
  w("safevalues_raw.dom.domParserParseFromString", wb);
  w("safevalues_raw.dom.domParserParseHtml", function (a, b) {
    return wb(a, b, "text/html");
  });
  w("safevalues_raw.dom.domParserParseXml", function (a, b) {
    a = wb(a, N(b), "text/xml");
  ...
  w("safevalues_raw.dom.fetchResourceUrl", function (a, b) {
    ...
    return ya(function (e) {
      if (e.g == 1) return qa(e, fetch(C(a).toString(), b));
      c = e.j;
      f =
  ...
  w("safevalues_raw.dom.globalEval", function (a, b) {
    b = U(b);
    var c = a.eval(b);
    c === b && (c = a.eval(b.toString()));
    return c;
  });
  w("safevalues_raw.dom.locationAssign", function (a, b) {
    b = K(b);
    b !== void 0 && a.assign(b);
  });
  w("safevalues_raw.dom.locationReplace", function (a, b) {
    b = K(b);
    b !== void 0 && a.replace(b);
  });
  w("safevalues_raw.dom.setLocationHref", function (a, b) {
    b = K(b);
    b !== void 0 && (a.href = b);
  });
  w("safevalues_raw.dom.rangeCreateContextualFragment", yb);
  w("safevalues_raw.dom.serviceWorkerContainerRegister", function (a, b, c) {
    return a.register(C(b), c);
  });
  w("safevalues_raw.dom.objectUrlFromSafeSource", function (a) {
    return Oa(a).toString();
  });
  w("safevalues_raw.dom.getScriptNonce", gb);
  w("safevalues_raw.dom.getStyleNonce", function (a) {
    return hb("style", a);
  });
  w("safevalues_raw.dom.windowOpen", function (a, b, c, d) {
    b = K(b);
    return b !== void 0 ? a.open(b, c, d) : null;
  });
  w("safevalues_raw.dom.createWorker", function (a, b) {
    return new Worker(C(a), b);
  });
  w("safevalues_raw.dom.createSharedWorker", function (a, b) {
    return new SharedWorker(C(a), b);
  });
  w("safevalues_raw.dom.workerGlobalScopeImportScripts", function (a) {
    a.importScripts.apply(
      a,
      ma(
        t.apply(1, arguments).map(function (b) {
          return C(b);
        })
      )
    );
  });
  w("safevalues_raw.restricted.legacy.legacyUnsafeHtml", function (a, b) {
    a = oc(a);
    return N(jc(a, b));
  });
  w("safevalues_raw.restricted.legacy.legacyUnsafeScript", function (a) {
    a = oc(a);
    return T(a);
  });
  w("safevalues_raw.restricted.legacy.legacyUnsafeResourceUrl", function (a) {
    a = oc(a);
    return B(a);
  });
  w("safevalues_raw.restricted.legacy.legacyUnsafeStyleSheet", function (a) {
    a = oc(a);
    return V(a);
  });
  w(
    "safevalues_raw.restricted.legacy.superLenientlySanitizeHtml",
    function (a) {
      return Y(ac, a);
    }
  );
  w("safevalues_raw.restricted.reviewed.htmlSafeByReview", function (a) {
    return N(a);
  });
  w("safevalues_raw.restricted.reviewed.scriptSafeByReview", function (a) {
    return T(a);
  });
  w("safevalues_raw.restricted.reviewed.resourceUrlSafeByReview", function (a) {
    return B(a);
  });
  w("safevalues_raw.restricted.reviewed.styleSheetSafeByReview", function (a) {
    return V(a);
  }); /*
    ...
    "undefined" != typeof navigator &&
      (function (t, e) {
        ...
        function requireSafevalues() {
          ...
          if (!safevalues) console.error("Could not load raw safevalues");
          return safevalues;
        }
        const safevalues = requireSafevalues();
        var t = "",
          e = !1,
          i = -999999,
          s = function () {
            ...
            function o(i) {
              if (window.Worker && window.Blob && e) {
                var s = new Blob(
                  ...
                  a = safevalues.trustedResourceUrl(s);
                return safevalues.dom.createWorker(a);
              }
              return (t = i), r;
            }
            function h() {
        ...
        var rt = (function () {
            ...
            return {
              ...
              getNewSegment: function (e, i, s, a, r, n, h) {
                ...
                for (l = 0; l < m; l += 1)
                  (p[4 * l] =
                    ...
                    (p[4 * l + 1] =
                      t.round(
                        1e3 * (_ * e[l] + k * s[l] + P * a[l] + A * i[l])
                      ) / 1e3),
                    (p[4 * l + 2] =
                      t.round(
                        1e3 * (S * e[l] + x * s[l] + w * a[l] + D * i[l])
                      ) / 1e3),
                    (p[4 * l + 3] =
                      t.round(
                        1e3 * (C * e[l] + M * s[l] + T * a[l] + F * i[l])
                      ) / 1e3);
                return p;
              },
              ...
              pointOnLine3D: function (i, s, a, r, n, o, h, l, p) {
                ...
                var f,
                  d = t.sqrt(
                    t.pow(r - i, 2) + t.pow(n - s, 2) + t.pow(o - a, 2)
                  ),
                  m = t.sqrt(
                    t.pow(h - i, 2) + t.pow(l - s, 2) + t.pow(p - a, 2)
                  ),
                  c = t.sqrt(
                    t.pow(h - r, 2) + t.pow(l - n, 2) + t.pow(p - o, 2)
                  );
                return (
                  (f =
                    d > m
              ...
              for (
                ...
                for (o = 0; o < l; o += 1)
                  (f = r ? s.i[n][o] : s.i[n][o] + (a.i[n][o] - s.i[n][o]) * p),
                    ...
                    (f = r
                      ? s.o[n][o]
                      : s.o[n][o] + (a.o[n][o] - s.o[n][o]) * p),
                    (e.o[n][o] = f),
                    (f = r
                      ? s.v[n][o]
                      : s.v[n][o] + (a.v[n][o] - s.v[n][o]) * p),
                    (e.v[n][o] = f);
            }
            function i() {
          ...
          (qt.prototype.processShapes = function (t) {
            ...
            if (this._mdf || t) {
              ...
              if (
                (r < 0 && (r += 1),
                (e =
                  this.s.v > 1 ? 1 + r : this.s.v < 0 ? 0 + r : this.s.v + r) >
                  (i =
                    this.e.v > 1 ? 1 + r : this.e.v < 0 ? 0 + r : this.e.v + r))
              ) {
                var n = e;
                (e = i), (i = n);
              }
          ...
          (qt.prototype.addShapes = function (t, e, i) {
            ...
            for (
              ...
              if (
                ...
                break;
              s < m - 1 &&
                ((i = At.newElement()), (g = !0), u.push(i), (o = 0));
            }
            return u;
          }),
          r([Bt], jt),
        ...
        function Qt(t, e, i, s, a) {
          a && oe(t, e) && (e = Jt(t, s, 1 / 3)),
            a && oe(i, s) && (i = Jt(t, s, 2 / 3));
            ...
            var o = (n + 1) / (s + 1),
              h =
                2 === a
                  ...
                  : 0,
              l = e.normalAngle(o);
            le(t, e.point(o), l, r, i, h / (2 * (s + 1)), h / (2 * (s + 1))),
              (r = -r);
          }
          return r;
        }
        ...
        function ge(t, e) {
          ...
          return (
            i.length && Yt(i[0][0], 1) && i.shift(), i.length ? i[0] : null
          );
        }
        function ye(t, e) {
          var i = t.slice(),
        ...
        function ve(t, e) {
          ...
          if (1 === n.length || Yt(n[1], 1))
            return (
              (i = (a = t.split(n[0]))[0]), (s = a[1]), [ce(i, e), ce(s, e)]
            );
          i = (a = t.split(n[0]))[0];
          var o = (n[1] - n[0]) / (1 - n[0]);
          return (
        ...
        r([Bt], Xt),
          ...
          (Qt.prototype.split = function (t) {
            ...
            var e = Jt(this.points[0], this.points[1], t),
              ...
              n = Jt(a, r, t);
            return [
              new Qt(this.points[0], e, a, n, !0),
              new Qt(n, r, s, this.points[3], !0),
            ];
          }),
          ...
          (he.prototype.processPath = function (t, e, i, s) {
            ...
            for (var h = 0; h < a; h += 1)
              (n = de(r, o, e, i, s, -n)),
                (o =
                  h !== a - 1 || t.c ? Qt.shapeSegment(t, (h + 1) % a) : null),
                fe(r, t, h + 1, e, i, s, n);
            return r;
          }),
          ...
          (be.prototype.processPath = function (t, e, i, s) {
            ...
            var l = [];
            for (r = 0; r < h; r += 1)
              (o = Qt.shapeSegment(t, r)), l.push(ve(o, e));
            if (!t.c)
              for (r = h - 1; r >= 0; r -= 1)
        ...
        function Le(t, e) {
          ...
          var a,
            r = s.length;
          for (i = 0; i < r; i += 1)
            (a = new Ve(s[i], e)), this.effectElements.push(a);
        }
        function Ve(t, e) {
          this.init(t, e);
        }
        ...
        (je.prototype = {
          initTransform: function () {
            ...
            (this.finalTransform = {
              mProp: this.data.ks
                ? Wt.getTransformProperty(this, this.data.ks, this)
                : { o: 0 },
              _matMdf: !1,
              _localMatMdf: !1,
              _opMdf: !1,
              ...
              for (p = 0; p < u; p += 1) {
                if (((h = s.sh._mdf || a), s.styles[p].lvl < g)) {
                  for (
                    ...
                    (h = s.transformers[c].mProps._mdf || h),
                      (m -= 1),
                      (c -= 1);
                  if (h)
                    for (
                      ...
                      d.multiply(s.transformers[c].mProps.v),
                        (m -= 1),
                        (c -= 1);
                } else d = t;
                  ...
                  6 === d
                    ? (f === p
                        ...
                        : ((s = e(t(0, s + 0.5 - p), f - p)),
                          (l =
                            (1 +
                              Math.cos(Math.PI + (2 * Math.PI * s) / (f - p))) /
                            2)),
                      (l = h(l)))
                    : (s >= i(p) &&
        ...
        (ki.prototype.searchProperties = function () {
          ...
          for (t = 0; t < i; t += 1)
            (e = this._textData.a[t]),
              (this._animatorsData[t] = new _i(this._elem, e, this));
          ...
          (Pi.prototype.createPathShape = function (t, e) {
            ...
            for (i = 0; i < a; i += 1)
              "sh" === e[i].ty &&
                ((s = e[i].ks.k), (r += ci(s, s.i.length, !0, t)));
            return r;
          }),
