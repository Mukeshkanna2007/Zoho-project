(function (g) {
  ...
  var KB4 = function (a) {
    ...
    kAd = function (a) {
      g.F.call(this, { W: "div", T: "ytp-related-on-error-overlay" });
      var I = this;
      this.api = a;
      this.Y = this.L = 0;
      ...
      this.previous = new g.F({
        ...
        S: { "aria-label": "Show previous suggested videos" },
        Z: [g.cE()],
      });
      ...
      this.next = new g.F({
        ...
        S: { "aria-label": "Show more suggested videos" },
        Z: [g.WE()],
      });
      g.E(this, this.J);
      a = a.X();
      this.api.N("embeds_web_enable_pause_overlay_rounding") &&
        g.x5(this.element, "ytp-error-overlay-round-corners");
      this.D = a.J;
      g.E(this, this.title);
      this.title.KO(this.element);
      this.suggestions = new g.F({ W: "div", T: "ytp-suggestions" });
      ...
      g.E(this, this.j);
      for (var U = { XK: 0 }; U.XK < 16; U = { XK: U.XK }, U.XK++) {
        var e = new g.F({
          W: "a",
          T: "ytp-suggestion-link",
          S: { href: "{{link}}", target: a.j, "aria-label": "{{aria_label}}" },
          Z: [
            {
              W: "div",
            ...
            { W: "div", T: "ytp-suggestion-author", AU: "{{views_or_author}}" },
          ],
        });
        g.E(this, e);
          ...
          (function (C) {
            return function (r) {
              ...
              I.api.N(
                ...
                ? (I.api.logClick(I.V[q].element),
                  (q = x.ys()),
                  (x = {}),
                  g.EK(I.api, x),
                  (q = g.pM(q, x)),
                  g.Jw(q, I.api, r))
                : g.bV(r, I.api, I.D, Z || void 0) &&
                  I.api.pT(x.videoId, Z, x.playlistId);
            };
          })(U)
        );
        this.V.push(e);
    ...
    VaI = function (a, I) {
      if (
        ...
        for (
          var U = Math.floor(-a.scrollPosition / (a.B + a.L)),
            e = Math.min(U + a.columns, a.suggestionData.length) - 1;
          U <= e;
          U++
        )
    ...
    Maj = function (a) {
      for (var I = 0; I < a.suggestionData.length; I++) {
        ...
        if (
          g.YH(r) &&
          !r.N("web_player_log_click_before_generating_ve_conversion_params")
        ) {
          var q = {};
        ...
        g.Vl.test(U.title)
          ? (q.dir = "rtl")
          : g.Xrf.test(U.title) && (q.dir = "ltr");
        q = e.Ws("ytp-suggestion-author");
        g.Vl.test(T) ? (q.dir = "rtl") : g.Xrf.test(T) && (q.dir = "ltr");
        e.update({
          views_or_author: T,
          duration: U.isLivePlayback
            ? "Live"
            : U.lengthSeconds
            ? g.XT(U.lengthSeconds)
            : "",
          link: C,
          hover_title: U.title,
          title: U.title,
        ...
        T = U.Ub();
        e.Ws("ytp-suggestion-image").style.backgroundImage = T
          ? "url(" + T + ")"
          : "";
        r.N("web_player_log_click_before_generating_ve_conversion_params") &&
          (a.api.createServerVe(e.element, e),
          (U = (U = U.sessionData) && U.itct) &&
            a.api.setTrackingParams(e.element, U));
      }
      for (; I < a.V.length; I++) a.V[I].element.style.display = "none";
      Aeo(a);
    },
    zN = function (a) {
      g.pu.call(this, a);
        ...
        Z: [
          {
            ...
            Z: [
              { W: "path", S: { d: "M0 0h24v24H0V0z", fill: "none" } },
              {
                W: "path",
                S: {
      ...
      g.E(this, C);
      a.X().B ||
        ((this.V = new kAd(a)), this.V.KO(this.element), g.E(this, this.V));
    ...
    $fz = function (a, I) {
      ...
      U.style.paddingTop =
        (I.height - (a.V ? a.V.element.clientHeight : 0)) / 2 - e / 2 + "px";
    },
    gz4 = function (a, I) {
      var U = a.api.X(),
        e;
      I.reason &&
        (iff(I.reason) ? (e = KB4(g.Lb(I.reason))) : (e = g.fu(g.id(I.reason))),
        a.E9(e, "content"));
      var T;
      I.subreason &&
        (iff(I.subreason)
          ? (T = KB4(g.Lb(I.subreason)))
          : (T = g.fu(g.id(I.subreason))),
        a.E9(T, "subreason"));
      if (I.proceedButton && I.proceedButton.buttonRenderer) {
        ...
        if (
          ...
          var r;
          U =
            (r = g.d(I == null ? void 0 : I.navigationEndpoint, g.Fl)) == null
              ? void 0
              : r.url;
          var q;
          r =
            (q = g.d(I == null ? void 0 : I.navigationEndpoint, g.Fl)) == null
              ? void 0
              : q.target;
          U &&
    ...
    iff = function (a) {
      if (a.runs)
        for (var I = 0; I < a.runs.length; I++)
          if (a.runs[I].navigationEndpoint) return !0;
      return !1;
    },
    LB8 = function (a, I) {
      a = g.wr("A", a);
      for (var U = 0; U < a.length; U++) if (a[U].textContent === I) return !0;
      return !1;
    },
    cem = function (a, I) {
      g.F.call(this, {
        ...
        Z: [
          {
            ...
            S: { "aria-hidden": "true" },
            Z: [
              { W: "div", T: "ytp-impression-link-text", AU: "Watch on" },
              { W: "div", T: "ytp-impression-link-logo", AU: "{{logoSvg}}" },
            ],
          },
        ],
      });
        ...
        Z: [
          {
            ...
            S: { "aria-label": "Rewind 10 seconds", "aria-hidden": "false" },
          },
          {
            W: "button",
    ...
    oz = function (a) {
      ...
      g.F.call(this, {
        ...
        S: {
          target: I.j,
          href: "{{url}}",
          "aria-label": g.ji("Watch on $WEBSITE", { WEBSITE: g.DX(I) }),
    ...
    lkJ = function (a) {
      ...
      U =
        U.L4 &&
        !g.Q(a.state, 2) &&
        !g.TJ(g.O(a.api.getVideoData(1))) &&
        !(
          U.N("embeds_enable_emc3ds_woyt_counterfactual") &&
    ...
    PHG = function (a) {
            ...
            Z: [
              {
                ...
                S: { "aria-label": "Muted Playback Indicator" },
                Z: [
                  {
                    W: "div",
                            ...
                            Z: [
                              {
                                ...
                                S: { height: "9", width: "4", x: "1", y: "7" },
                              },
                              {
                                W: "rect",
                                T: "ytp-equalizer-bar-middle",
                                S: { height: "14", width: "4", x: "6", y: "2" },
                              },
                              {
                                W: "rect",
      ...
      this.hide();
      a.isMutedByEmbedsMutedAutoplay() && (Bez(this), this.Oc(), Xfz(this));
      g.E(this, this.B);
    },
    Xfz = function (a) {
      a.gF && a.V && (a.V.show(), a.B.start());
    },
    Bez = function (a) {
      a.watermark ||
        ((a.watermark = new oz(a.api)),
        g.E(a, a.watermark),
    ...
    Dd = function (a) {
      ...
      this.expandButton = new g.F({
        ...
        AU: this.api.isEmbedsShortsMode() ? "More shorts" : "More videos",
      });
      a.X().controlsType === "0" &&
        g.x5(a.getRootNode(), "ytp-pause-overlay-controls-hidden");
      this.api.N("embeds_web_enable_pause_overlay_rounding") &&
        g.x5(this.element, "ytp-pause-overlay-round-corners");
      g.E(this, this.B);
      g.E(this, this.fade);
      var U = new g.F({
        W: "button",
        ...
        Z: [{ W: "div", T: "ytp-collapse-icon", Z: [g.SS()] }],
      });
      g.E(this, U);
      U.KO(this.element);
        ...
        Z: [
          {
            ...
            Z: [
              ...
              { W: "span", T: "ytp-countdown-timer-time", AU: "{{duration}}" },
            ],
          },
        ],
      });
    ...
    GAz = function (a) {
      ...
      I !== a.j &&
        ((a.j = I),
        a.U && (a.U.dispose(), (a.U = null)),
        a.B && (a.B.dispose(), (a.B = null)),
        a.J && (a.J.dispose(), (a.J = null)),
        a.L && (a.L.stop(), a.L.dispose(), (a.L = null)),
        I &&
          ((I = g.O(g.Lh(a.K))),
          a.K.isEmbedsShortsMode() &&
            ((a.J = new g.F({
              W: "div",
    ...
    SRo = function (a, I) {
      a.L &&
        ((!g.Q(I, 4) && !g.Q(I, 2)) || g.Q(I, 1024) ? a.L.hide() : a.L.show());
    },
    YRj = function (a) {
      var I = a.K;
      a = !!I.isEmbedsShortsMode();
      g.KC(I.getRootNode(), "ytp-shorts-mode", a);
      if ((I = I.getVideoData())) I.FO = a;
    },
    at = function (a, I) {
      var U = a.K.X();
      a = {
  ...
  g.H.resize = function (a, I) {
    ...
    if (Math.min(a.width, a.height) <= 150 || r === 0 || !U.uj) this.hide();
    else {
      var q;
      if (T) {
        var x = (q = 28);
  ...
  g.H.onVideoDataChange = function () {
    ...
    this.D = a.uc ? !1 : I.J;
    a.suggestions
      ? (this.suggestionData = g.Sa(a.suggestions, function (U) {
    ...
    a.uc
      ? this.title.update({
          title: g.ji("More videos from $DNI_RELATED_CHANNEL", {
  ...
  g.H.scrollTo = function (a) {
    a = g.WA(
      a,
      this.containerWidth - this.suggestionData.length * (this.B + this.L),
      0
    );
  ...
  zN.prototype.L = function (a) {
    ...
    if (I.zW || I.playerErrorMessageRenderer)
      (a = I.zW)
        ? gz4(this, a)
        : I.playerErrorMessageRenderer &&
          gz4(this, I.playerErrorMessageRenderer);
    else {
      var U;
      a.IM &&
        (I.a_
  ...
  g.H.onVideoDataChange = function () {
    ...
    g.r4(a)
      ? ((I = usz()),
        (U = 216165),
        g.x5(this.element, "ytp-music-impression-link"))
      : g.ta(this.element, "ytp-music-impression-link");
    this.api.X().N("embeds_enable_emc3ds_woyt_counterfactual") &&
      g.x5(this.element, "ytp-woyt-emc3ds-cf");
  ...
  g.H.Oi = function () {
    ...
    I = I.B;
    e || C || U || T || I || this.api.isEmbedsShortsMode() || !a.videoId
      ? (this.hide(), this.api.logVisibility(this.element, !1))
      : ((a = WBG(this)), this.updateValue("url", a), this.show());
  };
  ...
  hI.prototype.UK = function () {
    ...
    !this.api.MV() || (g.Q(a, 2) && g.OK(this.api)) || g.Q(a, 64)
      ? (this.api.logVisibility(this.V, !1),
  ...
  Np.prototype.B = function () {
    ...
    this.api.X().N("embeds_enable_muted_autoplay_shorts_endscreen_fix") &&
      g.KC(this.element, "ytp-shorts-mode", this.api.isEmbedsShortsMode());
    !I.mutedAutoplay ||
      (I.limitedPlaybackDurationInSeconds === 0 &&
        I.endSeconds === 0 &&
        I.mutedAutoplayDurationMode === 2) ||
      (g.Q(a, 2) && !this.gF
        ? (this.show(),
          this.V ||
            ((this.V = new g.X6(this.api)),
            g.E(this, this.V),
            this.V.KO(this.J, 0),
            this.V.show()),
  ...
  g.H.onVideoDataChange = function () {
    ...
    I.videoId && !a.B
      ? ((a = this.api.getVideoUrl(!0, !1, !1, !0)),
        ...
        this.V || (this.V = this.listen("click", this.onClick)))
      : this.V &&
        (this.updateValue("url", null), this.YY(this.V), (this.V = null));
    a = JeD();
    var U = 76758;
    g.r4(I) && ((a = usz()), (U = 216164));
  ...
  g.H.Oc = function () {
    var a = this.api.getPlayerStateObject();
    !g.O(this.api.getVideoData()).mutedAutoplay || g.Q(a, 2)
      ? this.hide()
      : this.gF ||
        (g.F.prototype.show.call(this),
        this.api.logVisibility(this.element, this.gF));
  ...
  g.H.onMutedAutoplayEnds = function () {
    this.watermark && (this.watermark.Bs(), (this.watermark = null));
  };
  g.u(Dd, g.F);
  ...
  vs.prototype.stopTimer = function () {
    this.V && (this.V.dispose(), (this.V = null), (this.L = !1));
  };
  ...
  g.H.create = function () {
    var a = this.K.X(),
      I = g.Lh(this.K),
      U,
      e = (U = this.K.getVideoData()) == null ? void 0 : U.clientPlaybackNonce;
    e && g.z5({ clientPlaybackNonce: e });
    a.i5 && !a.disableOrganicUi && GAz(this);
    var T;
    ((T = a.getWebPlayerContextConfig()) != null && T.embedsEnableEmc3ds) ||
      ((this.D = new PHG(this.K)),
      g.E(this, this.D),
    ...
    var C, r;
    ((C = this.K.X().getWebPlayerContextConfig()) == null
      ? 0
      : (r = C.embedsHostFlags) == null
      ? 0
      : r.allowOverridingVisitorDataPlayerVars) &&
      (a = g.D5("IDENTITY_MEMENTO")) &&
      this.K.rA("onMementoChange", a);
  };
  g.H.onCueRangeEnter = function (a) {
    a.getId() === "countdown timer" &&
      this.countdownTimer &&
      (this.countdownTimer.show(), fkj(this.countdownTimer));
  };
  ...
  g.H.eM = function (a) {
    g.Q(a, 128)
      ? (this.Xf ||
          ((this.Xf = new zN(this.K)),
          g.E(this, this.Xf),
          g.w4(this.K, this.Xf.element, 4)),
        this.Xf.L(a.VR),
        this.Xf.show(),
        g.x5(this.K.getRootNode(), "ytp-embed-error"))
      : this.Xf &&
        (this.Xf.dispose(),
        (this.Xf = null),
    ...
    if (this.countdownTimer && this.countdownTimer.V)
      if (g.Q(a, 64))
        ...
        a.isPlaying() &&
          ...
          ((I = this.countdownTimer),
          I.L && ((I.J += (0, g.w)() - I.Y), (I.L = !1), pff(I)));
    SRo(this, a);
  };
  g.H.onMutedAutoplayStarts = function () {
    g.O(this.K.getVideoData()).mutedAutoplay &&
      this.D &&
      g.KC(this.K.getRootNode(), "ytp-muted-autoplay", !0);
  };
  g.H.onVideoDataChange = function (a, I) {
    var U = this.pL !== I.videoId;
    a = !U && a === "dataloaded";
    var e = { isShortsModeEnabled: !!this.K.isEmbedsShortsMode() };
    ...
    U &&
      ...
      this.C &&
        (this.K.HE("embeds"),
        I.isAd() ||
          I.limitedPlaybackDurationInSeconds < 5 ||
          g.y7(this.K) ||
          ((I = Math.max(
            (I.startSeconds + I.limitedPlaybackDurationInSeconds - 5) * 1e3,
            0
          )),
          (I = new g.qA(I, I + 5e3, {
            id: "countdown timer",
          ...
          this.K.xw([I]))),
      this.K.X().i5 && !this.K.X().disableOrganicUi && (YRj(this), GAz(this)));
