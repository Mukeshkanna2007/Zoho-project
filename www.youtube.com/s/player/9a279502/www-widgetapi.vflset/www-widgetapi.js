(function () {
  ...
  r("Symbol", function (a) {
    ...
    function c(e, h) {
      this.g = e;
      p(this, "description", { configurable: !0, writable: !0, value: h });
    }
    if (a) return a;
  ...
  r("Promise", function (a) {
    ...
    b.prototype.j = function () {
      ...
      var g = this,
        k = !1;
      return { resolve: h(this.J), reject: h(this.l) };
    };
    ...
    typeof Object.assign == "function"
      ...
      : function (a, b) {
          for (var c = 1; c < arguments.length; c++) {
            var d = arguments[c];
            if (d) for (var f in d) F(d, f) && (a[f] = d[f]);
          }
          return a;
        };
      ...
      if (m && F(g[0], l))
        for (g = 0; g < m.length; g++) {
          ...
          if ((k !== k && u.key !== u.key) || k === u.key)
            return { id: l, list: m, index: g, o: u };
        }
...
*/
  ...
  function fb() {
    ...
    if (db())
      ...
      b =
        ((R().indexOf("Chrome") != -1 || R().indexOf("CriOS") != -1) &&
          (db() || R().indexOf("Edge") == -1)) ||
        R().indexOf("Silk") != -1;
    ...
    if (c) {
      ...
      if (this.A)
        for (e = 0; e < c.length; e++)
          (f = c[e]), jb(this.g[f + 1], this.g[f + 2], d);
      else {
        this.m++;
        try {
  ...
  function X(a, b) {
    ...
    if ((a = typeof a === "string" ? c.getElementById(a) : a)) {
      ...
      c ||
        (W.yt_embedsEnableAutoplayAndVisibilitySignals
    ...
    if (W.yt_embedsEnableIframeSrcWithIntent) {
      ...
      a: if (((e = e === void 0 ? Ua : e), c instanceof K)) e = c;
        ...
        for (f = 0; f < e.length; ++f)
          if (((a = e[f]), a instanceof Ta && a.R(c))) {
            e = new K(c);
            break a;
          }
        e = void 0;
      ...
      for (f = 0; f < c.length; f++)
        (b.sandbox.supports && !b.sandbox.supports(c[f])) ||
          b.sandbox.add(c[f]);
      if (e instanceof K)
  ...
  function Bb(a, b) {
    ...
    window.location.href &&
      va(["debugjs", "debugcss"], function (f) {
        ...
        b: {
          ...
          for (var k = f.length; (g = e.indexOf(f, g)) >= 0 && g < h; ) {
            ...
            if (l == 38 || l == 63)
              if (
                ((l = e.charCodeAt(g + k)), !l || l == 61 || l == 38 || l == 35)
              )
                break b;
            g += k + 1;
          }
            ...
            ? (a[d.u] = (function (f) {
                return function () {
                  ...
                  return this.playerInfo[
                    e.charAt(h).toLowerCase() + e.substring(h + 1)
                  ];
                };
              })(d))
            : (a[d.u] = (function (f) {
  ...
  function Mb(a) {
    if (a.tagName.toLowerCase() !== "iframe") {
      var b = vb(a, "videoid");
      b &&
        ((b = { videoId: b, width: vb(a, "width"), height: vb(a, "height") }),
        new X(a, b));
    }
  }
  function Hb(a, b, c) {
          ...
          if (e && d.origin === e.N)
            switch (
              ...
              case "apiInfoDelivery":
                if (H(f))
                  for (var h in f) f.hasOwnProperty(h) && (d.v[h] = f[h]);
                break;
              case "infoDelivery":
                Jb(d, f);
                break;
